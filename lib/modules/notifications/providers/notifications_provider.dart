...
import 'package:demo_flutter_cursor/modules/notifications/providers/models/notification_list.dart';
...
final notificationsPageStateProvider =
    AsyncNotifierProvider<NotificationsNotifier, NotificationsList>(
      NotificationsNotifier.new,
    );

const itemPerPage = 10;

class NotificationsNotifier extends AsyncNotifier<NotificationsList> {
  var _locked = false;
  ...
  Future<void> readAll() async {
    ...
    try {
      ...
      final List<Notification> oldNotifications =
          state
              .value! //
              .data
