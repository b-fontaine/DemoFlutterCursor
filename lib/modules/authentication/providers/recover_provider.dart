...
import 'package:demo_flutter_cursor/modules/authentication/providers/models/recover_state.dart';
...
class RecoverStateNotifier extends StateNotifier<RecoverState> {
  ...
  RecoverStateNotifier({required AuthenticationRepository authRepository})
    : _authRepository = authRepository,
      super(RecoverState(email: Email("")));
