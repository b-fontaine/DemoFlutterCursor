...
class TranslationsPlantsEn {
	...
	String get plant_species => 'Species';
	String get care_notes => 'Care Notes';
	String get name_hint => 'Enter plant name';
	String get species_hint => 'Enter plant species';
	String get care_notes_hint => 'Enter care instructions (optional)';
	String get save_plant => 'Save Plant';
	String get plant_saved => 'Plant saved successfully';
	String get empty_state => 'No plants yet. Add your first plant!';
	String get loading => 'Loading plants...';
	String get name_required => 'Plant name is required';
	String get species_required => 'Species is required';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'plants.plant_species': return 'Species';
			case 'plants.care_notes': return 'Care Notes';
			case 'plants.name_hint': return 'Enter plant name';
			case 'plants.species_hint': return 'Enter plant species';
			case 'plants.care_notes_hint': return 'Enter care instructions (optional)';
			case 'plants.save_plant': return 'Save Plant';
			case 'plants.plant_saved': return 'Plant saved successfully';
			case 'plants.empty_state': return 'No plants yet. Add your first plant!';
			case 'plants.loading': return 'Loading plants...';
			case 'plants.name_required': return 'Plant name is required';
			case 'plants.species_required': return 'Species is required';
			default: return null;
		}
	}
}
