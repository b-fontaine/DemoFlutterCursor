import 'package:demo_flutter_cursor/core/widgets/page_background.dart';
import 'package:demo_flutter_cursor/modules/notifications/providers/notifications_provider.dart';
import 'package:demo_flutter_cursor/modules/notifications/ui/components/notification_tile.dart';
import 'package:demo_flutter_cursor/modules/notifications/ui/widgets/empty_notifications.dart';
import 'package:demo_flutter_cursor/modules/notifications/ui/widgets/notification_tile.dart';
            ...
            slivers: [
              ...
              SliverPadding(
                ...
                sliver: notificationsState.when(
                                ...
                                delegate: SliverChildBuilderDelegate(
                                  (context, index) => NotificationTileComponent(
                                    ...
                                    onTap:
                                        (notification) => ref
                                            .read(
                                              notificationsPageStateProvider
                                                  .notifier,
                                            )
                  ...
                  error:
                      (err, stacktrace) => SliverToBoxAdapter(
                        child: Center(
                          child: Text(
