...
class TranslationsPlantsEn {
	...
	// Translations
	String get title => 'My Plants';
	String get add_plant => 'Add Plant';
	String get plant_name => 'Plant Name';
	String get plant_type => 'Plant Type';
	String get plant_description => 'Description';
	String get no_plants => 'No plants yet';
	String get add_first_plant => 'Add your first plant!';
	String get plant_added => 'Plant added successfully';
	String get plant_updated => 'Plant updated successfully';
	String get name_required => 'Plant name is required';
	String get type_required => 'Plant type is required';
	String get save => 'Save';
	String get cancel => 'Cancel';
	String get loading => 'Loading plants...';
	String get error_loading => 'Error loading plants';
	String get error_saving => 'Error saving plant';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'plants.title': return 'My Plants';
			case 'plants.add_plant': return 'Add Plant';
			case 'plants.plant_name': return 'Plant Name';
			case 'plants.plant_type': return 'Plant Type';
			case 'plants.plant_description': return 'Description';
			case 'plants.no_plants': return 'No plants yet';
			case 'plants.add_first_plant': return 'Add your first plant!';
			case 'plants.plant_added': return 'Plant added successfully';
			case 'plants.plant_updated': return 'Plant updated successfully';
			case 'plants.name_required': return 'Plant name is required';
			case 'plants.type_required': return 'Plant type is required';
			case 'plants.save': return 'Save';
			case 'plants.cancel': return 'Cancel';
			case 'plants.loading': return 'Loading plants...';
			case 'plants.error_loading': return 'Error loading plants';
			case 'plants.error_saving': return 'Error saving plant';
			default: return null;
		}
	}
}
