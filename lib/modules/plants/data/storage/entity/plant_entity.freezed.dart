...
@override
String toString() {
  return 'PlantEntity(id: $id, creationDate: $creationDate, lastUpdateDate: $lastUpdateDate, name: $name, type: $type, description: $description)';
}
...
class _PlantEntity extends PlantEntity {
  const _PlantEntity({required this.id, this.creationDate, this.lastUpdateDate, required this.name, required this.type, this.description}): super._();
